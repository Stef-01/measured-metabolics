...
export const MEALS: MealLog[] = [
  ...
  },
  {
    ...
    cuisine: "anglo",
    photoEmoji: "🥣",
    eatenAt: todayMinus(1, 7, 30),
    reviewStatus: "approved",
    analysis: {
      foods: [
        {
          name: "steel cut oats",
          quantity: "3/4 cup cooked",
          confidence: 0.93,
        },
        { name: "low-fat milk", quantity: "splash", confidence: 0.87 },
        { name: "blueberries", quantity: "small handful", confidence: 0.9 },
      ],
      carbLoad: "moderate",
      proteinLoad: "low",
      fibreLoad: "high",
      ...
      confidence: 0.9,
      dietitianSummary:
        "High-fibre oats; beta-glucan slows gastric emptying, stable response.",
      clinicalFlags: [],
    },
  },
  {
    ...
    cuisine: "anglo",
    photoEmoji: "🥗",
    eatenAt: todayMinus(1, 12, 30),
    reviewStatus: "approved",
    analysis: {
      foods: [
        { name: "tuna", quantity: "95g tin", confidence: 0.94 },
        {
          name: "wholegrain crispbread",
          quantity: "3 pieces",
          confidence: 0.88,
        },
        { name: "cherry tomatoes", quantity: "handful", confidence: 0.85 },
        { name: "cucumber", quantity: "1/2 cup", confidence: 0.82 },
      ],
      carbLoad: "low",
      proteinLoad: "high",
      fibreLoad: "moderate",
      fatLoad: "low",
      cuisineTags: ["Anglo"],
      cgmPeakDeltaMmol: 1.0,
      cgmPeakAtMin: 55,
      confidence: 0.89,
      dietitianSummary: "High-protein, low-carb lunch; minimal glucose impact.",
      clinicalFlags: [],
    },
  },
  {
    ...
    photoEmoji: "🍝",
    eatenAt: todayMinus(1, 21, 0),
    reviewStatus: "pending_review",
    analysis: {
      foods: [
        { name: "wholegrain pasta", quantity: "1 cup cooked", confidence: 0.9 },
        {
          name: "roasted vegetables",
          quantity: "large serve",
          confidence: 0.87,
        },
        { name: "olive oil", quantity: "1 tbsp", confidence: 0.84 },
        { name: "parmesan", quantity: "1 tbsp", confidence: 0.8 },
      ],
      carbLoad: "moderate",
      proteinLoad: "low",
      fibreLoad: "high",
  ...
  },
  {
    ...
    analysis: {
      foods: [
        { name: "grilled chicken breast", quantity: "150g", confidence: 0.93 },
        { name: "quinoa", quantity: "1/2 cup cooked", confidence: 0.88 },
        { name: "mixed salad leaves", quantity: "large", confidence: 0.86 },
        { name: "lemon dressing", quantity: "1 tbsp", confidence: 0.79 },
      ],
      carbLoad: "low",
      proteinLoad: "high",
      fibreLoad: "moderate",
      ...
      confidence: 0.91,
      dietitianSummary:
        "Excellent macros — high protein, complete amino acids, controlled carb.",
      clinicalFlags: [],
    },
  },
  {
