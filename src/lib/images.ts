...
export function mealImageBySlug(slug: string | null | undefined): string {
  ...
  if (s.includes("poha") || s.includes("khichdi") || s.includes("upma"))
    return MEAL.poha;
  if (s.includes("biryani") || s.includes("pulao") || s.includes("pilaf"))
    return MEAL.southAsian;
  if (s.includes("tandoori") || s.includes("tikka") || s.includes("korma"))
    return MEAL.southAsian;
  if (s.includes("curry") || s.includes("masala") || s.includes("saag"))
    return MEAL.southAsian;
  if (
    s.includes("dal") ||
    s.includes("dhal") ||
  ...
  if (
    ...
    return MEAL.southAsian;
  if (s.includes("fish") || s.includes("prawn") || s.includes("shrimp"))
    return MEAL.southAsian;
  ...
  if (
    ...
    return MEAL.asian;
  if (s.includes("noodle") || s.includes("pad thai") || s.includes("laksa"))
    return MEAL.asian;
  if (
    s.includes("stir fry") ||
    s.includes("stir-fry") ||
  ...
  if (
    ...
    s.includes("lo mein") ||
    s.includes("vermicelli")
  )
    return MEAL.asian;
  if (s.includes("bibimbap") || s.includes("kimchi") || s.includes("bulgogi"))
    return MEAL.asian;

  // Mediterranean / Middle Eastern
  if (s.includes("falafel") || s.includes("hummus") || s.includes("tzatziki"))
    return MEAL.mediterranean;
  if (
    s.includes("shawarma") ||
    s.includes("doner") ||
    ...
    return MEAL.mediterranean;
  if (s.includes("tabouleh") || s.includes("couscous") || s.includes("pita"))
    return MEAL.mediterranean;
  if (
    s.includes("greek") &&
    (s.includes("salad") || s.includes("bowl") || s.includes("chicken"))
  )
    return MEAL.mediterranean;
  ...
  if (
    s.includes("bowl") &&
    (s.includes("buddha") || s.includes("poke") || s.includes("grain"))
  )
    return MEAL.salad;

  // Eggs / toast / sandwiches (savoury handheld)
  if (s.includes("avocado")) return MEAL.toast;
  if (s.includes("toast") || s.includes("bruschetta") || s.includes("crostini"))
    return MEAL.toast;
  if (
    s.includes("omelette") ||
    s.includes("omelet") ||
    s.includes("frittata") ||
    s.includes("scrambled")
  )
    return MEAL.toast;
  ...
  if (
    ...
    s.includes("bagel") ||
    s.includes("baguette") ||
    s.includes("flatbread")
  )
    return MEAL.toast;
  if (s.includes("taco") || s.includes("pizza")) return MEAL.toast;

  // Sweet / fruit breakfast
  if (s.includes("smoothie") || s.includes("acai") || s.includes("açaí"))
    return MEAL.fruit;
  if (s.includes("oatmeal") || s.includes("porridge") || s.includes("oats"))
    return MEAL.fruit;
  if (s.includes("granola") || s.includes("muesli") || s.includes("parfait"))
    return MEAL.fruit;
  if (s.includes("yogurt") || s.includes("yoghurt")) return MEAL.fruit;
  if (s.includes("pancake") || s.includes("waffle") || s.includes("crepe"))
    return MEAL.fruit;
  if (s.includes("fruit") || s.includes("berry") || s.includes("berries"))
    return MEAL.fruit;
  if (
    s.includes("banana") ||
    s.includes("apple") ||
  ...
  if (
    ...
    s.includes("spinach") ||
    s.includes("kale") ||
    s.includes("asparagus")
  )
    return MEAL.greens;
  if (s.includes("roasted") || s.includes("steamed") || s.includes("grilled"))
    return MEAL.greens;
  if (
    s.includes("chicken") ||
    s.includes("turkey") ||
